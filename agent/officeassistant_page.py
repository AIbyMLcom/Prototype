...
def officeassistant_page():
    ...
    st.sidebar.markdown("####Job Specifications of AI Office Assistant")
    st.sidebar.markdown(
        f"""
    - Sorting documents into files
    - Send out personalised email
    - Organise email received
    - Help Recruitment
    - Arrange Events
    - Organise meetings
    - Minute Taking
