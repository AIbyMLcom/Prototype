...
def write_st_end():
    ...
    st.markdown("---")
    st.markdown(
        "Developed and Maintained by the Team of AIbyML.com"
    )
    st.markdown(
        "[AIbyML.com](https://www.aibyml.com) - A start-up dedicated to the well-beings of humanity using AI"
    )
    #st.markdown()
    #st.markdown()
...
def show_st_structure(df,
    ...
    end_str = f"Powered by [Rascore](https://github.com/mitch-parker/rascore) (PDB: RAS [{pdb_code.upper()}](https://www.rcsb.org/structure/{pdb_code}))."
